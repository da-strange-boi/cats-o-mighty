    ...
    if(message.author.id === "295255543596187650"){
        ...
        if(args[2]){
            ...
            Cat.findOne({
                ...
                if(args[1] === "bandit"){catList.bandit = catList.bandit + amtCat;}if(args[1] === "bug"){catList.bug = catList.bug + amtCat;}if(args[1] === "linda"){catList.linda = catList.linda + amtCat;}if(args[1] === "mittens"){catList.mittens = catList.mittens + amtCat;}if(args[1] === "cash"){catList.cash = catList.cash + amtCat;}if(args[1] === "jackson"){catList.jackson = catList.jackson + amtCat;}if(args[1] === "cottonball"){catList.cottonball = catList.cottonball + amtCat;}if(args[1] === "sonny"){catList.sonny = catList.sonny + amtCat;}if(args[1] === "smokey"){catList.smokey = catList.smokey + amtCat;}if(args[1] === "lailah"){catList.lailah = catList.lailah + amtCat;}if(args[1] === "cher"){catList.cher = catList.cher + amtCat;}if(args[1] === "marvin"){catList.marvin = catList.marvin + amtCat;}
        ...
        if(args[1]){
            ...
            Cat.findOne({
                ...
                if(args[0] === "abyssinian"){catList.abyssinian = catList.abyssinian + amtCat;}if(args[0] === "manx"){catList.manx = catList.manx + amtCat;}if(args[0] === "sphynx"){catList.sphynx = catList.sphynx + amtCat;}if(args[0] === "cyprus"){catList.cyprus = catList.cyprus + amtCat;}if(args[0] === "foldex"){catList.foldex = catList.foldex + amtCat;}
