      ...
      if(args[1]){
        ...
        for(let i=0;i < animalList.length; i++){
          if(animal === animalList[i]){
            ...
            if(i >= 22 && i <= 35){catSellPrice = 2500} // special
            if(i >= 36){catSellPrice = 10000} // impossible
