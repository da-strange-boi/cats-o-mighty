...
exports.run = async (bot, message, args) => {
  ...
  bot.db.Userdata.findOne({userID: user}, (err, userdata) => {
    ...
    .setColor(bot.config.color.owner);
    ...
    uAbyssinian = userdata.cats.abyssinian;uManx = userdata.cats.manx;uSphynx = userdata.cats.sphynx;uCyprus = userdata.cats.cyprus;uFoldex = userdata.cats.foldex;uTurkishAngora = userdata.cats.turkishangora;uNorwegianForest = userdata.cats.norwegianforest;uDevonrex = userdata.cats.devonrex;
